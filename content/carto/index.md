  ...
  <section class="section container-fluid mt-n3 pb-0">
    <div class="row justify-content-center">
      <div class="col-lg-16 text-center">
        ...
        ">CARTO Alternative <span class="d-inline-block">for Data Teams</span></h1>
      </div>
      <div class="col-lg-12 text-center">
        <p class="lead">
          <span class="d-inline-block">Open-source map analytics for <b>BigQuery</b> and <b>Snowflake</b>.</span>
          <span class="d-inline-block">Write SQL, get maps instantly. No data movement, no vendor lock-in.</span>
        </p>
        <p>
          <em class="d-inline-block mark">Free plan available. Paid plans from $49/month.</em>
        </p>
      </div>
